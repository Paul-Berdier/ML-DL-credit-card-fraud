...
def main():
    ...
    if choice == "7" or choice == "8":
        ...
        train_ml_model(reformed_data_file, output_roc_curve, output_learning_curve, target_column='Class', output_model_file=model_file)
        display_message(f"Modèle sauvegardé sous : {model_file}")
